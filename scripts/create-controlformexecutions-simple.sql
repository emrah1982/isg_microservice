-- Kontrol Formu Uygulamaları için basit veritabanı tabloları
USE activities_db;
...
CREATE TABLE IF NOT EXISTS ControlFormExecutions (
    ...
    Notes TEXT NULL,
    ChecklistResponsesJson TEXT NULL,
...
INSERT IGNORE INTO ControlFormExecutions (
    ...
    1,
    CONCAT('EXE-', DATE_FORMAT(NOW(), '%Y%m%d'), '-001'),
    'Test Makinesi',
    'Model-X1',
    'Üretim Sahası A',
    'Test Personeli',
    'InProgress',
    'Test kontrol uygulaması',
    '[]'
);
